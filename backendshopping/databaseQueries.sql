...
Insert into category(name,description,image_url,is_active) VALUES ('Laptop','this is the description for Laptop','Cat_1.png',true);
Insert into category(name,description,image_url,is_active) VALUES ('Television','this is the description for Television','Cat_2.png',true);
Insert into category(name,description,image_url,is_active) VALUES ('Mobile','this is the description for Mobile','Cat2.png',true);
