					...
					<sf:form class="form-horizontal" modelAttribute="product"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<sf:errors path="name" cssClass="help" element="em" />
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<sf:errors path="brand" cssClass="help" element="em" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea path="description" id="description" rows="4"
									placeholder="Enter the description here!" class="form-control"></sf:textarea>
								<sf:errors path="description" cssClass="help" element="em" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="unitPrice" id="unitprice"
									class="form-control" />
								<sf:errors path="unitPrice" cssClass="help" element="em" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<sf:errors path="file" cssClass="help" element="em" />
							</div>
						</div>
						<div class="form-group">
